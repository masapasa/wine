    ...
    <>
      ...
      ">
        ...
        <div className="pt-16 iconitos">
          <Image width={36} height={36} src="/assets/cart.svg" />
          <div className="ml-6 float-right">
            <Image width={36} height={36} src="/assets/heart.svg" />
          </div>
        </div>
        <div className="w-2/3 float-right pt-4">
          ...
          {(<button className="wine-button p-2 border rounded border-gray-600 w-18 self-center justify-self-end text-gray-600">
            ❤
          </button>)}
        </div>
